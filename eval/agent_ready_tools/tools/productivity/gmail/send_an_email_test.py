...
from agent_ready_tools.tools.productivity.gmail.send_an_email import send_an_email


def test_send_an_email() -> None:
    ...
    with patch(
        "agent_ready_tools.tools.productivity.gmail.send_an_email.get_google_client"
