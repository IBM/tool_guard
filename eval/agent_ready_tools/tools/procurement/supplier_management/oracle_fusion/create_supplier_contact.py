...
def oracle_fusion_create_supplier_contact(
    supplier_id: str,
    first_name: str,
    last_name: str,
    ...
    """
    Creates a supplier contact in Orcale fusion.
    ...
    Returns:
        creates contact details for the given supplier.
    """
    ...
    response = client.post_request(
        resource_name=f"suppliers/{supplier_id}/child/contacts", payload=payload
    )
    ...
    return ToolResponse(
        success=True,
        message="Created contact for a supplier in Oracle Fusion.",
