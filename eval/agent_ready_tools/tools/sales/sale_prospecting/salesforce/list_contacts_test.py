...
from agent_ready_tools.tools.sales.sale_prospecting.salesforce.list_contacts import (
    list_sales_contacts,
)
...
def test_list_contacts() -> None:
    ...
    with patch(
        "agent_ready_tools.tools.sales.sale_prospecting.salesforce.list_contacts.get_salesforce_client"
        ...
        response = list_sales_contacts(search="Name=Stella Pavlova")
